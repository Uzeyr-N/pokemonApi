...
function getPokemon() {
  ...
  const url =
    `https://pokeapi.co/api/v2/pokemon/${userChoice}?offset=20&limit=150`.toLowerCase();
  ...
  fetch(url)
    ...
    .then((res) => {
      ...
      //!DOM manipulation getting the data direct from the api and putting in the dom //!
